    ...
    return (
        <div>
            ...
            <div className="overflow-x-hidden">
                ...
                <section className="bg-gradient-to-t from-white/[55%] to-transparent px-5 py-8 dark:bg-white/[0.03] dark:bg-none lg:py-20">
                        ...
                        <div className="container">
                            <div className="relative">
                                ...
                                <div className="grid gap-4 lg:grid-cols-2">
                                    ...
                                    <div className="pb-20 lg:pb-8 lg:pt-20" data-aos="fade-up" data-aos-duration="1000">
                ...
                <section className="bg-white/50 py-14 dark:bg-white/[0.03] lg:py-20">
                    <div className="container">
                        ...
                        <div
                            className="mt-14 grid gap-4 rounded-2xl px-4 py-8 sm:p-10 lg:mt-20 lg:grid-cols-2"
                            style={{
                        ...
                        <div
                            className="mt-10 grid gap-4 rounded-2xl px-4 py-8 sm:p-10 lg:mt-16 lg:grid-cols-2"
                            style={{
                    ...
                    <div className="container">
                        ...
                        <div className="grid gap-14 sm:grid-cols-2 lg:grid-cols-3">
                            <div data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <p className="mb-8 mt-6 line-clamp-4 text-lg font-semibold">
                ...
                <section className="px-5 py-[60px] dark:bg-gray-dark">
                    <Testimonial
                ...
                <div className="relative bg-black py-14 lg:py-24">
                    <img src="/assets/images/modern-saas/newsletter.svg" alt="" className="absolute bottom-0 right-0 hidden xl:inline-block" />
                    <img src="/assets/images/modern-saas/email.svg" alt="" className="absolute bottom-0 left-40 hidden md:left-1/2 xl:inline-block" />
                    <div className="container">
                        <div className="flex flex-col justify-between gap-5 md:flex-row">
                            <div className="relative text-center md:w-1/2 ltr:md:text-left rtl:md:text-right xl:pr-12">
                                ...
                                <h2 className="relative mb-3 text-3xl font-black text-white md:text-4xl xl:text-6xl">
                                    Email Newsletter
                                    <img src="/assets/images/modern-saas/icon-2.svg" alt="" className="absolute -bottom-5 right-8" />
                                </h2>
                                ...
                                <form className="relative mt-14">
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-xl py-4 font-semibold outline-0 ltr:pl-14 ltr:pr-32 rtl:pl-32 rtl:pr-14 lg:py-6 lg:text-lg"
                                    />
                                    <button
                                        type="button"
